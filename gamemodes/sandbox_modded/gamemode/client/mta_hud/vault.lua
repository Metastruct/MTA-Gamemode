...
return function()
	...
	mat_vec.x = (-30 * MTAHud.Config.ScrRatio) + (MTAHud.Vars.LastTranslateY * 2)
	mat_vec.y = (-100 * MTAHud.Config.ScrRatio) + (MTAHud.Vars.LastTranslateP * 3)
	...
	surface.DrawRect(x, y, 400 * coef, 55 * MTAHud.Config.ScrRatio)

	surface.SetDrawColor(orange_color)
	surface.DrawOutlinedRect(x, y, 400 * coef, 55 * MTAHud.Config.ScrRatio, 2)
	...
	surface.SetDrawColor(orange_color)
	surface.DrawRect(x + 10 * coef, y + (35 * MTAHud.Config.ScrRatio), margin, 10)

	surface.SetTextPos(x + 15 * coef + margin, y + (25 * MTAHud.Config.ScrRatio))
